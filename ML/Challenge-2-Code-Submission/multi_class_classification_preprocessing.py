# -*- coding: utf-8 -*-
"""Test-Image-Processing-Challenge-2.ipynb
...
lesion_type = "xxx"
data_file = "/content/drive/My Drive/CAD/Challenge 2/test/*.jpg"
...
for filename in glob.glob(data_file):
  ...
  cv2.imwrite("/content/drive/My Drive/CAD/Challenge 2/{0}_seg/s_{1}".format(lesion_type, name), final_img)
...
# img_b = cv2.GaussianBlur(img_gray, (3,3), 0)
